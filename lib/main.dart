...
class _MyHomePageState extends State<MyHomePage> {
  ...
  List<UserData> _dummyUserDataList = [
    UserData("Olivia",23,"Nice to meet you","https://cdn.pixabay.com/photo/2017/03/30/18/17/girl-2189247_1280.jpg",['Shop','Sleep','Netflix','Travel','Movie','Eat','Party']),
                        ...
                        return Stack(
                          children: [
                            Container(
                              ...
                              child: ClipRRect(
                                child: Image.network(
                                  _dummyUserDataList[index].userImageUrl,
                                  fit: BoxFit.cover,
                                ),
